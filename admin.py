...
class LBChangeRequestAdmin(UnfoldModelAdmin):
    ...
    list_filter   = ('status', 'template__change_type')
...
class CredentialRotationEventAdmin(UnfoldModelAdmin):
...
class LBDecommissionedAdmin(UnfoldModelAdmin):
    ...
    def has_add_permission(self, request):
        """Prevent manual creation of decommission records from the admin."""
        return False
