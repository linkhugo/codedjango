...
urlpatterns = [
    ...
    path('services/delete-no-vip/', views.servicio_delete_no_vip, name='servicio_delete_no_vip'),
    ...
    path('vips/lookup/export/', views.vip_lookup_export, name='vip_lookup_export'),
    ...
    path('infrastructure/decommissioned/', views.LBDecommissionedListView.as_view(), name='lb_decommissioned_list'),

    # Infrastructure - Compliance dashboard
    path('infrastructure/compliance/', views.company_compliance, name='company_compliance'),
    path('infrastructure/version-drift/', views.version_drift, name='version_drift'),
    path('infrastructure/eol-timeline/', views.eol_timeline, name='eol_timeline'),
    path('infrastructure/eol-charts/', views.eol_charts, name='eol_charts'),

    # F5 Catalog — software versions
    path('infrastructure/f5-versions/', views.F5SoftwareVersionListView.as_view(), name='f5_version_list'),
    path('infrastructure/f5-versions/add/', views.F5SoftwareVersionCreateView.as_view(), name='f5_version_add'),
    path('infrastructure/f5-versions/<int:pk>/edit/', views.F5SoftwareVersionUpdateView.as_view(), name='f5_version_edit'),
    path('infrastructure/f5-versions/<int:pk>/delete/', views.F5SoftwareVersionDeleteView.as_view(), name='f5_version_delete'),

    # F5 Catalog — hardware models
    path('infrastructure/f5-models/', views.F5HardwareModelListView.as_view(), name='f5_model_list'),
    path('infrastructure/f5-models/add/', views.F5HardwareModelCreateView.as_view(), name='f5_model_add'),
    path('infrastructure/f5-models/<int:pk>/edit/', views.F5HardwareModelUpdateView.as_view(), name='f5_model_edit'),
    path('infrastructure/f5-models/<int:pk>/delete/', views.F5HardwareModelDeleteView.as_view(), name='f5_model_delete'),
    ...
    path('hardening/bitacora/bulk/', views.bitacora_hardening_bulk_action, name='bitacora_hardening_bulk_action'),
    ...
    # Descargas
    path('downloads/', views.vip_download, name='vip_download'),

    # LB Change Checklist
    path('lb-changes/', views.LBChangeListView.as_view(), name='lb_change_list'),
    path('lb-changes/add/', views.LBChangeCreateView.as_view(), name='lb_change_add'),
    path('lb-changes/<int:pk>/', views.lb_change_workspace, name='lb_change_workspace'),
    path('lb-changes/<int:pk>/edit/', views.LBChangeUpdateView.as_view(), name='lb_change_edit'),
    path('lb-changes/<int:pk>/delete/', views.LBChangeDeleteView.as_view(), name='lb_change_delete'),
    path('lb-changes/templates/', views.LBChangeTemplateListView.as_view(), name='lb_change_template_list'),
    path('lb-changes/templates/add/', views.LBChangeTemplateCreateView.as_view(), name='lb_change_template_add'),
    path('lb-changes/templates/<int:pk>/edit/', views.LBChangeTemplateUpdateView.as_view(), name='lb_change_template_edit'),
    path('lb-changes/templates/<int:pk>/delete/', views.LBChangeTemplateDeleteView.as_view(), name='lb_change_template_delete'),
    path('lb-changes/templates/<int:pk>/items/', views.template_item_list, name='lb_change_template_items'),
    path('lb-changes/templates/<int:pk>/items/<int:item_pk>/edit/', views.LBChangeTemplateItemUpdateView.as_view(), name='lb_change_template_item_edit'),
    path('lb-changes/templates/<int:pk>/items/<int:item_pk>/delete/', views.LBChangeTemplateItemDeleteView.as_view(), name='lb_change_template_item_delete'),

    # Credential Rotation Tracker
    path('credentials/', views.CredentialListView.as_view(), name='credential_list'),
    path('credentials/add/', views.CredentialCreateView.as_view(), name='credential_add'),
    ...
    path('credentials/<int:pk>/rotate/', views.credential_register_rotation, name='credential_rotate'),
    path('credentials/<int:pk>/history/', views.credential_history, name='credential_history'),
    path('credentials/policies/', views.CredentialPolicyListView.as_view(), name='credential_policy_list'),
    path('credentials/policies/add/', views.CredentialPolicyCreateView.as_view(), name='credential_policy_add'),
    path('credentials/policies/<int:pk>/edit/', views.CredentialPolicyUpdateView.as_view(), name='credential_policy_edit'),
    path('credentials/policies/<int:pk>/delete/', views.CredentialPolicyDeleteView.as_view(), name='credential_policy_delete'),
